 ...
 * @date 2014.1.05
 */
public class TestIHTPADD_02_chal_matrix {		
	...
	public static void main (String [] args) throws Exception{
		...
		for(int count=0;count<1;count++){						
			...
			for(int n=0;n<challCounts.length;n++){
				...
				double total=DataFilter.roundDouble(DoTime+CSPTime+VerTime+transTime,3);
				StdOut.println(challCount+"\t"+DoTime+"\t"+CSPTime+"\t"+VerTime+"\t"+transTime+"\t"+total);
